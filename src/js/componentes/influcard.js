...
// Aqui creo una plantilla de influcard para luego poder reutilizarla con los datos procedurales
...
export function creaInflucard(params) {
  ...
  const statsData = [
    {
      label: "Audiencia",
      value: params.cantidadAudiencia,
      icon: `
